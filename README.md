...
```
msd/
├── build.mjs                    gerador (~120 linhas, sem deps)
├── dist/msd-dossie.html         saída publicável — não edite, é regenerado
└── src/
    ├── manifest.json            ordem das seções e dos nós da árvore + metadados
